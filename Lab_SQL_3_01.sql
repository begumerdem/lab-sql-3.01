...
VALUES
(3,'Tammy','Sanders',4,'TAMMY.SANDERS@sakilacustomer.org',2, 1, 'Tammy', NULL, '2022-09-19 16:37');
...
SELECT * FROM rental
ORDER BY rental_id DESC; -- last rental_id = 1604;
SELECT * FROM rental
...
SELECT * FROM rental -- check the table
